...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby(by = ['Vehicle_Type', 'unemployment_rate'])[ 'Automobile_Sales'].mean().reset_index()
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x= 'Year', y = 'Automobile_Sales', title = f'Line plot for yearly Automobile Sales.'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mas,
            x = 'Month',
            y = 'Automobile_Sales',
            title='Line plot for Total Monthly Automobile Sales'))
